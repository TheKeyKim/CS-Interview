...
> 교착 상태(DeadLock)이를 정의하고 4가지 필요조건과 해결방법을 아는대로 말씀해주세요
```
- 비선점형 
- 상호배제 
- 자원의 할당과 대기 
...
> 뮤텍스, 세마포어가 무엇인지 설명해주시고 그둘의 차이점에 대해 말씀해주세요
...
> Scheduling에 대해 정의하고, 아는 스케쥴링 기법을 설명해주세요
...
> 문맥교환(Context Switching)에 대해 아는대로 설명해주세요
